...
export abstract class Yaml {
    ...
    public static getInstance(type: string): Model {
        ...
        switch(type) {
            ...
            case Warning.name: return new Warning()
            ...
            case Legend.name: return new Legend()
            case Conspiracy.name: return new Conspiracy()
            case Prophecy.name: return new Prophecy()
            case Code.name: return new Code()
            case Exaggeration.name: return new Exaggeration()
            case Challenge.name: return new Challenge()
            case Motivation.name: return new Motivation()
            case Terror.name: return new Terror()
            case Hero.name: return new Hero()
            case Erotic.name: return new Erotic()
            case Edition.name: return new Edition()
            case Research.name: return new Research()
            case Study.name: return new Study()
            case Surprise.name: return new Surprise()
            case Experiment.name: return new Experiment()
            case Statistics.name: return new Statistics()
            case Urgent.name: return new Urgent()
            case PersonalExperience.name: return new PersonalExperience()
            case Benefit.name: return new Benefit()
            case Imagine.name: return new Imagine()
            case Authority.name: return new Authority()
            case Feelings.name: return new Feelings()
            case Childhood.name: return new Childhood()
            case Game.name: return new Game()
            case TurningPoint.name: return new TurningPoint()
            case CliffHanger.name: return new CliffHanger()
            case HumanScale.name: return new HumanScale()
            case SocialAcceptance.name: return new SocialAcceptance()
            default: {
