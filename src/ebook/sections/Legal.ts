...
export class LegalSection implements Section {
    ...
    public async build() {
        ...
        new LegalTextAdapter(Yaml.getString('@i18n/Copyright.yaml')).apply()
        new LegalTextAdapter(Yaml.getString('@i18n/Warrant.yaml')).apply()
        new LegalTextAdapter(Yaml.getString('@i18n/Resources.yaml')).apply()
    }
}
