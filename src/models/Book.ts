...
export class Book implements Model {
    ...
    public readonly audience: Text = new Text()
    public readonly goal: Text = new Text()
    public readonly prerequisites: Text = new Text()
    ...
    public async build(): Promise<void> {
        ...
        await this.audience.build()
        await this.goal.build()
        await this.prerequisites.build()
    }
    ...
    public serialise(): SerializedBook {
        return {
            ...
            "Goal": this.goal.serialise(),
            "Prerequisites": this.prerequisites.serialise(),
            "Audience": this.audience.serialise(),
    ...
    public deserialise(data: SerializedBook): void {
        if (data) {
            ...
            this.goal.deserialise(data.Goal)
            this.prerequisites.deserialise(data.Prerequisites)
            this.audience.deserialise(data.Audience)
